...
export const DetailList = ({title, srcList, url}: DetailListProps) => {
    ...
    const visitTitles = ["game","airbnb", "musicPlayer","service","bucketList" ,"budget" , "messenger"]
            ...
            <div className='w-full flex flex-col gap-2 items-center justify-center'>
              <div className='w-full flex items-center justify-between font-semibold bg-gradient-to-r from-white to-white/0 text-[var(--clr-orange)]  pl-4 py-3 mt-12  rounded-l-full '>
                ...
                <div className=' pr-20'>
                  ...
                  ? (
                    <Link href={`https://${url}`}><p className='cursor-pointer transition hover:underline underline-offset-3 z-50 text-white/75 flex flex-row items-center gap-2  hover:text-shadow-lg hover:text-white'> Visit now <FaHandPointRight /></p></Link>) 
                  : (
              ...
              <div className='w-full shadow-inner shadow-white/50 rounded-l-xl rounded-br-xl p-[1em] h-[50vh] xl:h-[65vh] flex lg:grid grid-cols-1 xl:grid-cols-2 gap-[calc(1em_+_3vw)] xl:gap-6 xl:px-[calc(0.5em_+_1vw)]'>
