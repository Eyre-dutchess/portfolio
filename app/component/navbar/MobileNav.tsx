...
export const MobileNav = ({showNav, navList, setShowNav}: MobileNavProps) => {
  ...
  return(
    <div className={`lg:hidden block w-screen h-screen fixed top-0 left-0 bg-white z-50  text-xl z-40 transition duration-500 origin-top transform ${show?"scale-100":"scale-0"}`}>
